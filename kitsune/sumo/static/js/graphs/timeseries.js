(function() {
    ...
    d3.chart('SpecLines').extend('TimeSeries', {
        initialize: function() {
            ...
            this.zeroLine = this.zeroLine.x(G.compose(G.get(0), this.scaleX));
            this.line = this.line.x(G.compose(G.get(0), this.scaleX));
            ...
            this.layer('brush', brushBase, {
                ...
                events: {
                    enter: G.compose(G.popThis, d3.select),
                }
            });
            ...
            // this.svg.append('g')
            //     .attr('transform', G.format('translate(0,{0})', this.padding()[2]))
            //     .call(this.brush)
            //     .selectAll('rect')
            //         .attr('height', 100)
            //         .style('stroke', '#00f')
